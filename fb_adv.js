...
(function (global) {
  function validateLicense(license, domain, callback) {
    ...
    const callbackName =
      "jsonp_callback_" + Math.random().toString(36).substring(2, 8);
    ...
    script.src = `https://script.google.com/macros/s/AKfycbx9SHqCdrpkTyubb5gtw8vwKh4x9J9VzLUfx6Z0mSVSsPHzvXi9Y6XCOQkXr8iluWDD/exec?action=validate&license=${encodeURIComponent(
      license
    )}&domain=${encodeURIComponent(domain)}&callback=${callbackName}`;
